...
#$ -P hpc-zz-aerosol
#$ -pe hpc.pe 640
# Yuan Sun, 2023-12-29, Manchester, UK
# This script is used to project1 case0 with default urban albedo in csf3
# case2: dynamic urban
# fault: the surface data is not true, should be default
export HOME="/mnt/iusers01/fatpou01/sees01/a16404ys"
export CASE_SCRIPT="/mnt/iusers01/fatpou01/sees01/a16404ys/CESM/my_cesm_sandbox_2.1.4_dyn_alb/cime/scripts"
export CASE_NAME="/mnt/iusers01/fatpou01/sees01/a16404ys/scratch/Projects/scratch/Case2"
export COMPSET=SSP370_DATM%CPLHIST_CLM50%SP_SICE_SOCN_MOSART_CISM2%NOEVOLVE_SWAV
export RES=f09_g17
export MACH=csf3
export RESTART="/mnt/iusers01/fatpou01/sees01/a16404ys/scratch/Projects/archive/case/rest/2015-01-01-00000"
if [ -d "${CASE_NAME}" ]; then
   rm -rf "${CASE_NAME}"
...
cd ${CASE_NAME}/${CASE_DOCS}

#for name1 in Solar State1hr State3hr nonSolarFlux; do
    #cp datm.streams.txt.CPLHISTForcing.${name1} user_datm.streams.txt.CPLHISTForcing.${name1}
    #echo "copy done"
#done

#for name2 in presaero topo; do
    #cp datm.streams.txt.${name2}.cplhist user_datm.streams.txt.${name2}.cplhist
    #echo "copy done"
#done
...
#echo "fsurdat = '/mnt/iusers01/fatpou01/sees01/a16404ys/scratch/Projects/inputdata/project1/surfdata_0.9x1.25_hist_16pfts_Irrig_CMIP6_simyr1850_c231120_urbanalbedo0.9.nc' " >> user_nl_clm
echo "fsurdat = '/mnt/iusers01/fatpou01/sees01/a16404ys/scratch/Projects/inputdata/lnd/clm2/surfdata_map/release-clm5.0.18/surfdata_0.9x1.25_hist_16pfts_Irrig_CMIP6_simyr1850_c190214.nc' " >> user_nl_clm
...
echo "rtmhist_nhtfrq = -87600" >> user_nl_mosart
./preview_namelists
./case.setup --reset
./case.build
./preview_run