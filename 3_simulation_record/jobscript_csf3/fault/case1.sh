...
export CASE_NAME="/mnt/iusers01/fatpou01/sees01/a16404ys/scratch/Projects/scratch/Case1"
...
echo "finidat_rtm = '20231212spinup.mosart.r.2015-01-01-00000.nc'" >> user_nl_mosart
./preview_namelists
./case.setup --reset
./case.build
./preview_run
