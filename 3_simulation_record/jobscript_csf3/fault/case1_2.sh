...
export CASE_NAME="/mnt/iusers01/fatpou01/sees01/a16404ys/scratch/Projects/scratch/Case1_2"
export COMPSET=SSP370_DATM%CPLHIST_CLM50%SP_SICE_SOCN_MOSART_CISM2%NOEVOLVE_SWAV
export RES=f09_g17
export MACH=csf3
export RESTART="/mnt/iusers01/fatpou01/sees01/a16404ys/scratch/Projects/archive/csf3/project1/case1/restart/2100-01-01-00000"
if [ -d "${CASE_NAME}" ]; then
   rm -rf "${CASE_NAME}"
