...
#$ -P hpc-zz-aerosol
#$ -pe hpc.pe 640
# Yuan Sun, 2024-1-7, Manchester, UK
# This script is used to project1 additional case
...
export CASE_NAME="/mnt/iusers01/fatpou01/sees01/a16404ys/scratch/Projects/scratch/Case_add"
export COMPSET=SSP370_DATM%CPLHIST_CLM50%SP_SICE_SOCN_MOSART_SGLC_SWAV
export RES=f09_g17
export MACH=csf3
export RESTART="/mnt/iusers01/fatpou01/sees01/a16404ys/scratch/Projects/archive/fromArcher2/project1/case_add/restart/2085-01-01-00000"
...
cd ${CASE_NAME}
./xmlchange RUN_STARTDATE=2085-01-01
./xmlchange NTASKS=640
./xmlchange STOP_OPTION=nyears
./xmlchange STOP_N=16
./xmlchange RESUBMIT=0
./xmlchange DATM_CPLHIST_CASE="b.e21.BSSP370cmip6.f09_g17.CMIP6-SSP3-7.0.102"
./xmlchange DATM_CPLHIST_YR_ALIGN=2085
./xmlchange DATM_CPLHIST_YR_START=2085
...
echo "Dynamic_UrbanAlbedoImproad = .true.">> user_nl_clm
