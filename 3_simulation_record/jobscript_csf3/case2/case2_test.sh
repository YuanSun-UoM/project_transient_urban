...
#$ -P hpc-zz-aerosol
#$ -pe hpc.pe 128
# Yuan Sun, 2024-04-07, Manchester, UK
# This script is used to project1 case0 with default urban albedo in csf3
# case2: dynamic urban
# cd /mnt/iusers01/fatpou01/sees01/a16404ys/CESM/jobscript/project1/case2
# qsub case2_test.sh
...
export CASE_NAME="/mnt/iusers01/fatpou01/sees01/a16404ys/scratch/Projects/scratch/case2_test"
...
echo "hist_fincl1 = 'TG_U', 'FSA_U'" >> user_nl_clm
