...
# cd /work/n02/n02/yuansun/shell_scripts/archive/project1/case0
# bash case0_1.sh
# squeue -u yuansun
...
export CASE_NAME="/work/n02/n02/yuansun/cesm/runs/case0_1"
export CASE_DOCS="CaseDocs"
export COMPSET=SSP370_DATM%CPLHIST_CLM50%SP_SICE_SOCN_MOSART_SGLC_SWAV
export RES=f09_g17
export PROJECT=n02-duicv
export MACH=archer2
export RESTART="/work/n02/n02/yuansun/cesm/archive/case0/rest/2058-01-01-00000"
