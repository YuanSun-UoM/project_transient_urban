#!/bin/bash  --login
# Yuan Sun, 2024-02-16, Manchester, UK
# This script is used to project1 case0 with default urban albedo
# cd /work/n02/n02/yuansun/cesm/runs/RCase0_1
# squeue -u yuansun
...
export CASE_NAME="/work/n02/n02/yuansun/cesm/runs/RCase0_1"
export CASE_DOCS="CaseDocs"
export COMPSET=SSP370_DATM%CPLHIST_CLM50%SP_SICE_SOCN_MOSART_SGLC_SWAV
export RES=f09_g17
export PROJECT=n02-duicv
export MACH=archer2
export RESTART="/work/n02/n02/yuansun/cesm/archive/RCase0/rest/2100-01-01-00000"
...
echo "hist_fincl1 = 'URBAN_AC','URBAN_HEAT','TBUILD_MAX','TBUILD','TSA_U','TSA_R','TG_U','TG_R','SWBGT_U','TREFMXAV_U','TREFMNAV_U', 'TREFMXAV_R','TREFMNAV_R','EFLX_LH_TOT_U','WASTEHEAT','FGR_U','FIRA_U','FIRE_U','FSA_U','FSH_U','FSM_U'" >> user_nl_clm
