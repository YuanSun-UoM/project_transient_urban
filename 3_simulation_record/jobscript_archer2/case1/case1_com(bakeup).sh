#!/bin/bash  --login
# Yuan Sun, 2024-03-12, Manchester, UK
# This script is used to project1 case1 with 0.9 roof albedo
# cd /work/n02/n02/yuansun/shell_scripts/archive/project1/case1
# bash case1_com.sh
# squeue -u yuansun
...
export CASE_NAME="/work/n02/n02/yuansun/cesm/runs/case1_com"
...
./xmlchange DATM_CPLHIST_YR_END=2016
...
cd ${CASE_NAME}
echo "fsurdat = '/work/n02/n02/yuansun/cesm/cesm_inputdata/lnd/project1/surfdata_0.9x1.25_hist_16pfts_Irrig_CMIP6_simyr1850_c231229_roofalbedo0.9.nc' " >> user_nl_clm
