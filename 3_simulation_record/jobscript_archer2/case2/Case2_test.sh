#!/bin/bash  --login
# Yuan Sun, 2024-03-08, Manchester, UK
# This script is used to project1 case2 with time-varying roof albedo
# cd /work/n02/n02/yuansun/shell_scripts/archive/project1/case2
# bash Case2_test.sh
# squeue -u yuansun
# examine if urban heat decrease year by year
...
export CASE_NAME="/work/n02/n02/yuansun/cesm/runs/case2_test2"
...
echo "hist_fincl1 = 'FSA_U', 'TG_U'" >> user_nl_clm
#echo "hist_fincl1 = 'URBAN_AC','URBAN_HEAT','TBUILD','TSA_U','TSA_R','TG_U','TG_R','SWBGT_U','TREFMXAV_U','TREFMNAV_U', 'TREFMXAV_R','TREFMNAV_R','EFLX_LH_TOT_U','WASTEHEAT','FGR_U','FIRA_U','FIRE_U','FSA_U','FSH_U','FSM_U'" >> user_nl_clm
#echo "hist_fincl2 = 'WIND','FSDS','HIA_U','APPAR_TEMP_U','SWBGT_U','HUMIDEX_U','DISCOIS_U','EFLX_LH_TOT_U','FGR_U','FIRA_U','FIRE_U','FSA_U','FSA_R','FSH_U','TBUILD','TREFMNAV_U','TREFMNAV_R','TREFMXAV_U','TREFMXAV_R','TSA_R','TSA_U','URBAN_AC','URBAN_HEAT','WASTEHEAT','TG_U','TG_R','FLDS','QBOT','PBOT','TBOT','RAIN','SNOW'" >> user_nl_clm
