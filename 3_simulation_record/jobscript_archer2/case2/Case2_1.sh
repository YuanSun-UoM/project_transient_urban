#!/bin/bash  --login
# Yuan Sun, 2024-03-06, Manchester, UK
# This script is used to project1 case2 with default urban albedo
...
export CASE_NAME="/work/n02/n02/yuansun/cesm/runs/case2_1"
export CASE_DOCS="CaseDocs"
export COMPSET=SSP370_DATM%CPLHIST_CLM50%SP_SICE_SOCN_MOSART_SGLC_SWAV
export RES=f09_g17
export PROJECT=n02-duicv
export MACH=archer2
export RESTART="/work/n02/n02/yuansun/cesm/archive/case2/rest/2100-01-01-00000"
