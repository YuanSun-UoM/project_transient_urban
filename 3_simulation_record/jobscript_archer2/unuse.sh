...
# This script is used to project1 case_add with all time-varying albedo branch run
...
export CASE_NAME="/work/n02/n02/yuansun/cesm/runs/Case_add_1"
export CASE_DOCS="CaseDocs"
export COMPSET=I2000Clm50Cn
export RES=f09_g17
export PROJECT=n02-duicv
export MACH=archer2
export RESTART="/work/n02/n02/yuansun/cesm/archive/Case_add/rest/2085-01-01-00000"
