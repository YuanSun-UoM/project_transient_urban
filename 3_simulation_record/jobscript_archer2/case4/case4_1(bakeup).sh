#!/bin/bash  --login
# Yuan Sun, 2024-1-3, Manchester, UK
# This script is used to project1 case4 with dynamic urban roof and improad albedo
...
export CASE_NAME="/work/n02/n02/yuansun/cesm/runs/Case4_1"
export CASE_DOCS="CaseDocs"
export COMPSET=SSP370_DATM%CPLHIST_CLM50%SP_SICE_SOCN_MOSART_SGLC_SWAV
export RES=f09_g17
export PROJECT=n02-duicv
export MACH=archer2
export RESTART="/work/n02/n02/yuansun/cesm/archive/Case4/rest/2095-01-01-00000"
...
./xmlchange DATM_CPLHIST_YR_ALIGN=2095
./xmlchange DATM_CPLHIST_YR_START=2095
