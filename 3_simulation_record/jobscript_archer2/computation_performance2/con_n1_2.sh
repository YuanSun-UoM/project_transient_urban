#!/bin/bash  --login
# Yuan Sun, 2024-1-26, Manchester, UK
...
export CASE_NAME="/work/n02/n02/yuansun/cesm/runs/con_n1_2017"
export CASE_DOCS="CaseDocs"
export COMPSET=SSP370_DATM%CPLHIST_CLM50%SP_SICE_SOCN_MOSART_SGLC_SWAV
export RES=f09_g17
export PROJECT=n02-duicv
export MACH=archer2
export RESTART="/work/n02/n02/yuansun/cesm/archive/con_n1_2016/rest/2017-01-01-00000"
...
./xmlchange DATM_CPLHIST_YR_ALIGN=2017
./xmlchange DATM_CPLHIST_YR_START=2017
./xmlchange DATM_CPLHIST_YR_END=2018
./xmlchange DATM_CPLHIST_DIR=/mnt/lustre/a2fs-nvme/work/n02/n02/yuansun/CPLHIST/SSP370
./xmlchange NTHRDS=1
./xmlchange RUN_TYPE=hybrid
./xmlchange RUN_REFDIR=${RESTART}
./xmlchange RUN_REFDATE=2017-01-01
./xmlchange RUN_REFTOD=00000
./xmlchange GET_REFCASE=TRUE
./xmlchange RUN_REFCASE=con_n1_2016
./case.setup
./preview_namelists
...
echo "fsurdat = '/work/n02/n02/yuansun/cesm/cesm_inputdata/lnd/project1/surfdata_0.9x1.25_hist_16pfts_Irrig_CMIP6_simyr1850_c240126_roofalsbedo0.03.nc'" >> user_nl_clm
