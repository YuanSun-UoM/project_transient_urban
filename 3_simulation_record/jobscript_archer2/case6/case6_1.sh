#!/bin/bash  --login
# Yuan Sun, 2024-3-9, Manchester, UK
# This script is used to project1 case6 with roof_tv, improad_tv, and wall_tv
# urban net solar radiation balance error for ib=           1  err=    1.0000352716155181E-003
# change to: if (abs(err) > 0.002_r8 ) then
...
export CASE_NAME="/work/n02/n02/yuansun/cesm/runs/case6_1"
export CASE_DOCS="CaseDocs"
export COMPSET=SSP370_DATM%CPLHIST_CLM50%SP_SICE_SOCN_MOSART_SGLC_SWAV
export RES=f09_g17
export PROJECT=n02-duicv
export MACH=archer2
export RESTART="/work/n02/n02/yuansun/cesm/archive/case6/rest/2058-01-01-00000"
...
cd ${CASE_NAME}
./xmlchange RUN_STARTDATE=2058-01-01
./xmlchange NTASKS=1280
./xmlchange STOP_OPTION=nyears
./xmlchange STOP_N=43
./xmlchange RESUBMIT=0
./xmlchange DATM_CPLHIST_CASE="b.e21.BSSP370cmip6.f09_g17.CMIP6-SSP3-7.0.102"
./xmlchange DATM_CPLHIST_YR_ALIGN=2058
./xmlchange DATM_CPLHIST_YR_START=2058
...
./xmlchange RUN_REFDATE=2058-01-01
./xmlchange RUN_REFTOD=00000
./xmlchange GET_REFCASE=TRUE
./xmlchange RUN_REFCASE=case6
./case.setup
./preview_namelists
