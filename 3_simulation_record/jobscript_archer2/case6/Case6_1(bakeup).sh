#!/bin/bash  --login
# Yuan Sun, 2024-2-21, Manchester, UK
# This script is used to project1 case2 with roof_tv, improad_tv, and wall_tv
# found the wall tv input has something wrong
# change if (abs(err) > 0.001_r8 ) then to if (abs(err) > 0.0013_r8 ) then in the UrbanAlbedoMod.F90 line 1246
...
export MACH=archer2
export RESTART="/work/n02/n02/yuansun/cesm/archive/Case6/rest/2083-01-01-00000"
...
cd ${CASE_NAME}
./xmlchange RUN_STARTDATE=2083-01-01
./xmlchange NTASKS=2560
./xmlchange STOP_OPTION=nyears
./xmlchange STOP_N=18
./xmlchange RESUBMIT=0
./xmlchange DATM_CPLHIST_CASE="b.e21.BSSP370cmip6.f09_g17.CMIP6-SSP3-7.0.102"
./xmlchange DATM_CPLHIST_YR_ALIGN=2083
./xmlchange DATM_CPLHIST_YR_START=2083
